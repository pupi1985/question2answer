...
return array(
	...
	'blobs_move_complete' => 'Migration of uploaded images and documents completed.', // @deprecated
	'blobs_move_moved' => 'Migration ^1 of ^2 uploaded images and documents', // @deprecated
	'blobs_stop' => 'Stop migrating', // @deprecated
	'blobs_to_db' => 'Blobs to database', // @deprecated
	'blobs_to_db_note' => '- migrate all uploaded images and documents from disk files to the database', // @deprecated
	'blobs_to_disk' => 'Blobs to disk', // @deprecated
	'blobs_to_disk_note' => '- migrate all uploaded images and documents from the database to disk files', // @deprecated
	'block_button' => 'block',
	...
	'caching_delete_complete' => 'Cache successfully deleted', // @deprecated
	'caching_delete_expired' => 'Delete expired cache',
	'caching_delete_progress' => 'Processed ^1 of ^2 cache items...',
	...
	'delete_hidden' => 'Delete hidden posts', // @deprecated
	'delete_hidden_complete' => 'All hidden posts without dependents have been deleted', // @deprecated
	'delete_hidden_note' => ' - all hidden questions, answer and comments without dependents', // @deprecated
	...
	'pixels' => 'pixels',
	'please_wait' => 'Please, wait...', // @since 1.8.9
	...
	'process_complete' => 'Process complete.', // @since 1.8.9
	'process_continue' => 'Continue process', // @since 1.8.9
	'process_restart' => 'Restart process', // @since 1.8.9
	'process_start' => 'Start process', // @since 1.8.9
	'process_stop' => 'Stop process', // @since 1.8.9
	'process_unfinished' => 'This process is unfinished', // @since 1.8.9
	...
	'recalc_blobs_to_db_note' => 'Migrate all uploaded images and documents from disk files to the database', // @since 1.8.9
	'recalc_blobs_to_db_title' => 'Blobs to database', // @since 1.8.9
	'recalc_blobs_to_disk_note' => 'Migrate all uploaded images and documents from the database to disk files', // @since 1.8.9
	'recalc_blobs_to_disk_title' => 'Blobs to disk', // @since 1.8.9
	'recalc_categories' => 'Recalculate categories', // @deprecated
	'recalc_categories_backpaths' => 'Recalculating URL paths for ^1 of ^2 categories...',
	'recalc_categories_complete' => 'All categories were successfully recalculated.', // @deprecated
	...
	'recalc_delete_hidden_posts_note' => 'All hidden questions, answer and comments without dependents', // @since 1.8.9
	'recalc_delete_hidden_posts_title' => 'Delete hidden posts', // @since 1.8.9
	...
	'recalc_needed' => 'The changes made require to manually run: ^1^2^3', // @since 1.8.9
	'recalc_points' => 'Recalculate user points', // @deprecated
	'recalc_points_complete' => 'All user points were successfully recalculated.', // @deprecated
	'recalc_points_note' => ' - for user ranking and points displays', // @deprecated
	'recalc_points_recalced' => 'Recalculated for ^1 of ^2 users...', // @deprecated
	'recalc_points_usercount' => 'Estimating total number of users...', // @deprecated
	'recalc_posts_count' => 'Counted ^1 of ^2 posts...', // @since 1.8.9 it receives 2 parameters
	'recalc_recalc_categories_note' => 'For post categories and category counts', // @since 1.8.9
	'recalc_recalc_categories_title' => 'Recalculate categories', // @since 1.8.9
	'recalc_recount_posts_note' => 'The number of answers, votes, flags and hotness for each post', // @since 1.8.9
	'recalc_recount_posts_title' => 'Recount posts', // @since 1.8.9
	'recalc_refill_events_note' => 'For each user\'s list of updates', // @since 1.8.9
	'recalc_refill_events_title' => 'Refill event streams', // @since 1.8.9
	'recalc_reindex_content_note' => 'For searching and related question suggestions', // @since 1.8.9
	'recalc_reindex_content_title' => 'Reindex content', // @since 1.8.9
	'recalc_stop' => 'Stop recalculating', // @deprecated
	'recalc_users_points_note' => 'For user ranking and points displays', // @since 1.8.9
	'recalc_users_points_recalced' => 'Recalculated for ^1 of ^2 users...', // @since 1.8.9
	'recalc_users_points_title' => 'Recalculate user points', // @since 1.8.9
	'recalc_users_points_usercount' => 'Counted ^1 of ^2 users...', // @since 1.8.9
	'recent_approve_title' => 'Recent content waiting for approval',
	'recent_hidden_title' => 'Recent hidden content',
	'recount_posts' => 'Recount posts', // @deprecated
	'recount_posts_as_recounted' => 'Recounted answers and hotness for ^1 of ^2 posts...',
	'recount_posts_complete' => 'All posts were successfully recounted.', // @deprecated
	'recount_posts_note' => ' - the number of answers, votes, flags and hotness for each post', // @deprecated
	'recount_posts_stop' => 'Stop recounting',
	'recount_posts_votes_recounted' => 'Recounted votes and flags for ^1 of ^2 posts...',
	'refill_events' => 'Refill event streams', // @deprecated
	'refill_events_complete' => 'All events streams were successfully refilled',
	'refill_events_note' => ' - for each user\'s list of updates', // @deprecated
	'refill_events_refilled' => 'Refilled for ^1 of ^2 questions...',
	'registration_fields' => 'add registration fields',
	'reindex_content' => 'Reindex content', // @deprecated
	'reindex_content_note' => ' - for searching and related question suggestions', // @deprecated
	'reindex_content_stop' => 'Stop reindexing',
	'reindex_pages_reindexed' => 'Reindexed ^1 of ^2 pages...',
	'reindex_posts_complete' => 'All posts were successfully reindexed.', // @deprecated
	...
	'save_recalc_button' => 'Save and Recalculate', // @deprecated
	...
	'stats_title' => 'Stats',
	'stop_recalc_warning' => 'A database clean-up operation is running. If you close this page now, the operation will be interrupted.', // @deprecated
	'tag_pages' => 'Tag pages',
	'tags' => 'Tags',
